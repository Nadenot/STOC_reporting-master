...
```{r fig.carte, eval=TRUE,fig.align = 'center', out.width='100%',fig.cap=paste("\\label{fig:carte}Localisation de la stations",site,"en jaune et des stations avec lequelles elle est comparée en ",couleur,". Les stations représentées par un petit point rouge  sont les autres stations, d'habitat ou de région différente"),fig.scap="La localisation de la station"}
